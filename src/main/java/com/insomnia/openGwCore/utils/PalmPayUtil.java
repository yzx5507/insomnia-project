package com.insomnia.openGwCore.utils;
...
//		amount=200.0&country=NG&currency=NGN&nonceStr=IBJGAeTa4ZJQv4Z2qufomVo9eI1YnJ9Y&notifyUrl=https://xx.cn/callback/payment&orderId=testc9ffae997fc4&orderType=1&requestTime=1.66217138994E12&title=pay&transType=24&userId=110&version=V1.1
//
//		558B089A3FF146BBC6FA999B60EDAB25
        String encryData = sb.substring(0, sb.length()-1);
		System.out.println("encryData: " +encryData);
        String md5 = Md5Util.MD5(encryData);
